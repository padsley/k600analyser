...
do
  ...
  if [ $COUNT -lt 10 ]
  then
      FILE="/home/luna/data/PR251/2016/run0000"$COUNT".mid.gz"
  elif [ $COUNT -lt 100 ]
  then
      FILE="/home/luna/data/PR251/2016/run000"$COUNT".mid.gz"
  elif [ $COUNT -lt 1000 ]
  then
...
#      FILE2="/vicepda/althome/k600user/PR251/2016/sortedfiles/sorted0000"$COUNT".root"
      FILE2="/home/luna/codes/PR251-analysis/sortedfiles/24Mg/Collimator/Corrected/Calibrated/calibrated0000"$COUNT".root"
  elif [ $COUNT -lt 100 ]
  then
#      FILE2="/vicepda/althome/k600user/PR251/2016/sortedfiles/sorted000"$COUNT".root"
      FILE2="/home/luna/codes/PR251-analysis/sortedfiles/24Mg/Collimator/Corrected/Calibrated/calibrated000"$COUNT".root"
  elif [ $COUNT -lt 1000 ]
  then
#      FILE2="/vicepda/althome/k600user/PR251/2016/sortedfiles/sorted00"$COUNT".root"
      FILE2="/home/luna/codes/PR251-analysis/sortedfiles/24Mg/Collimator/Corrected/Calibrated/calibrated00"$COUNT".root"
  elif [ $COUNT -lt 10000 ]
  then
#      FILE2="/vicepda/althome/k600user/PR251/2016/sortedfiles/sorted0"$COUNT".root"
      FILE2="/home/luna/codes/PR251-analysis/sortedfiles/24Mg/Collimator/Corrected/Calibrated/calibrated0"$COUNT".root"
  elif [ $COUNT -lt 100000 ]
  then
#      FILE2="/vicepda/althome/k600user/PR251/2016/sortedfiles/sorted"$COUNT".root"
      FILE2="/home/luna/codes/PR251-analysis/sortedfiles/24Mg/Collimator/Corrected/Calibrated/calibrated"$COUNT".root"
  else
      echo "This might not work"
  fi
  echo $FILE2

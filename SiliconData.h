...
class SiliconData
{
    ...
    std::vector<double> SiliconEnergyHighest;
    ...
    std::vector<double> SiliconTimeOffset_Front;
    std::vector<double> SiliconTimeOffset_Back;
    ...
    void SetEnergyHighest(double ener)		{SiliconEnergyHighest.push_back(ener);}
    ...
    void SetOffsetTime(double tim)	{SiliconTimeOffset_Front.push_back(tim);}
    void SetOffsetTime_Front(double tim)	{SiliconTimeOffset_Front.push_back(tim);}
    void SetOffsetTime_Back(double tim)	{SiliconTimeOffset_Back.push_back(tim);}

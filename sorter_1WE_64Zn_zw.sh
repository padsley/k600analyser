...
do
  ...
  if [ $COUNT -lt 10 ]
  then
      FILE2="/home/fdiel/Analysis_local/iThemba/root_64Zn/sorted0000"$COUNT"_zw.root"
  elif [ $COUNT -lt 100 ]
  then
      FILE2="/home/fdiel/Analysis_local/iThemba/root_64Zn/sorted000"$COUNT"_zw.root"
  elif [ $COUNT -lt 1000 ]
  then
      FILE2="/home/fdiel/Analysis_local/iThemba/root_64Zn/sorted00"$COUNT"_zw.root"
  elif [ $COUNT -lt 10000 ]
  then
      FILE2="/home/fdiel/Analysis_local/iThemba/root_64Zn/sorted0"$COUNT"_zw.root"
  elif [ $COUNT -lt 100000 ]
  then
      FILE2="/home/fdiel/Analysis_local/iThemba/root_64Zn/sorted"$COUNT"_zw.root"
  else
      echo "This might not work"
  fi
  echo $FILE2

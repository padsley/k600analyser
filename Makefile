...
#
MODULES   = adc.o qdc.o scaler.o SiliconData.o GammaData.o Parameters.o multiTDC.o MMM.o W1.o RawData.o HagarSort.o CloverSort.o GateauData.o GateauSort.o f-plane.o

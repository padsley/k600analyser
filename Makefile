...
#
MODULES   = adc.o qdc.o scaler.o SiliconData.o GammaData.o Parameters.o multiTDC.o MMM.o W1.o CloverData.o PR194CloverSort.o RawData.o HagarSort.o f-plane.o actarRawData.o actarSort.o

...
#
MODULES   = adc.o qdc.o tdc.o scaler.o beamline.o SiliconData.o GammaData.o Parameters.o multiTDC.o MMM.o W1.o RawData.o HagarSort.o CloverSort.o ScintillatorSort.o FocalPlane.o main.o

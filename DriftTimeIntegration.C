...
void DriftTimeIntegration()
{
    ...
    //      FULL PRUNED
    //std::vector<int> runNumbers{22364,22365,22368,22369,22370,22371,22372,22373,22374,22375,22377,22378,22379,23115,23116,23117,23118,23119,23125,23128,23129,23153,23156,23157,23159,23165,23166,23168,23171,23173,23174,23176,23180,23181,23184,23186,23187,23189,23191,23265,23266,23267,23271,23276,23280,23281,23282,23283,23284,23285,23287,23288,23294,23296,23297,23298,23299,23300,23301};
    
    //      FULL PRUNED - without COMB3
    //std::vector<int> runNumbers{22364,22365,22368,22369,22370,22371,22372,22373,22374,22375,22377,22378,22379,23115,23116,23117,23118,23119,23125,23128,23129,23265,23266,23267,23271,23276,23280,23281,23282,23283,23284,23285,23287,23288,23294,23296,23297,23298,23299,23300,23301};

    //      FULL PRUNED - without COMB3
    std::vector<int> runNumbers{22364,22365,22368,22369,22370,22371,22372,22373,22374,22375,22377,22378,22379};
